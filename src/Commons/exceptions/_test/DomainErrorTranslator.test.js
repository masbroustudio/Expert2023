...
describe('DomainErrorTranslator', () => {
  it('should translate error correctly', () => {
    ...
    expect(DomainErrorTranslator.translate(new Error('DELETE_AUTHENTICATION_USE_CASE.PAYLOAD_NOT_MEET_DATA_TYPE_SPECIFICATION')))
        .toStrictEqual(new InvariantError('refresh token harus string'));
    expect(DomainErrorTranslator.translate(new Error('ADD_THREAD.NOT_MEET_AUTHENTICATION_DATA')))
    ...
    expect(DomainErrorTranslator.translate(new Error('ADD_COMMENT.NOT_MEET_AUTHENTICATION_DATA')))
        .toStrictEqual(new AuthenticationError('Missing authentication'));
    ...
    expect(DomainErrorTranslator.translate(new Error('ADD_COMMENT.NOT_MEET_DATA_TYPE_SPECIFICATION')))
        .toStrictEqual(new InvariantError('tidak dapat membuat thread baru karena tipe data tidak sesuai'));
    expect(DomainErrorTranslator.translate(new Error('DELETE_COMMENT.NOT_MEET_AUTHENTICATION_DATA')))
        .toStrictEqual(new AuthenticationError('Missing authentication'));
    ...
    expect(DomainErrorTranslator.translate(new Error('ADD_REPLY.NOT_MEET_AUTHENTICATION_DATA')))
        .toStrictEqual(new AuthenticationError('Missing authentication'));
    ...
    expect(DomainErrorTranslator.translate(new Error('DELETE_REPLY_USE_CASE.NOT_CONTAIN_OWNER')))
        .toStrictEqual(new AuthenticationError('Missing authentication'));
    expect(DomainErrorTranslator.translate(new Error('DELETE_REPLY.NOT_MEET_AUTHENTICATION_DATA')))
        .toStrictEqual(new AuthenticationError('Missing authentication'));
