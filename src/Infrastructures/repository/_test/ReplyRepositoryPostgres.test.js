...
describe('ReplyRepositoryPostgres', () => {
  ...
  describe('addReply function', () => {
    it('should persist added reply', async () => {
      ...
      const replyRepositoryPostgres = new ReplyRepositoryPostgres(pool, fakeIdGenerator, fakeTimestampGenerator);
  ...
  describe('verifyReplyOwner function', () => {
    it('should throw NotFoundError when reply not found', async () => {
      ...
      // Action & Assert
      expect(replyRepositoryPostgres.verifyReplyOwner({replyId: 'reply-123', owner: 'user-123'}))
          .rejects
    ...
    it('should throw AuthorizationError when reply owner not match', async () => {
      ...
      // Assert
      await expect(replyRepositoryPostgres.verifyReplyOwner(result))
          .rejects
  ...
  describe('deleteReply function', () => {
    it('should delete reply', async () => {
      ...
      await replyRepositoryPostgres.deleteReply({replyId: replyRepository.id, owner: replyRepository.owner});
