...
DomainErrorTranslator._directories = {
  ...
  'ADD_THREAD.NOT_MEET_AUTHENTICATION_DATA': new AuthenticationError('Missing authentication'),
  ...
  'ADD_COMMENT.NOT_MEET_AUTHENTICATION_DATA': new AuthenticationError('Missing authentication'),
  ...
  'DELETE_REPLY_USE_CASE.NOT_CONTAIN_OWNER': new AuthenticationError('Missing authentication'),
  'DELETE_REPLY.NOT_MEET_AUTHENTICATION_DATA': new AuthenticationError('Missing authentication'),
