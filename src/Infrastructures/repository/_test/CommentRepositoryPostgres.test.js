...
describe('CommentRepositoryPostgres', () => {
  ...
  describe('addComment function', () => {
    it('should persist added comment', async () => {
      ...
      const commentRepositoryPostgres = new CommentRepositoryPostgres(pool, fakeIdGenerator, fakeTimestampGenerator);
  ...
  describe('verifyAvailableComment function', () => {
    it('should throw NotFoundError when comment not available', async () => {
      ...
      // Action & Assert
      await expect(commentRepositoryPostgres.verifyAvailableComment('comment-123')).rejects.toThrowError('komentar tidak ditemukan');
    });
  ...
  describe('verifyCommentOwner function', () => {
    ...
    it('should throw Anda tidak berhak mengakses resource ini when comment owner not match', async () => {
      ...
      // Assert
      await expect(commentRepositoryPostgres.verifyCommentOwner(result)).rejects.toThrowError('Anda tidak berhak mengakses resource ini');
    });
    ...
    it('should not throw AuthorizationError when comment owner match', async () => {
      ...
      // Assert
      await expect(commentRepositoryPostgres.verifyCommentOwner(result)).resolves.not.toThrowError('Missing authentication');
    });
  });
  ...
  describe('deleteComment function', () => {
    it('should delete comment correctly', async () => {
      ...
      // Action
      await commentRepositoryPostgres.addComment(addComment);
      await commentRepositoryPostgres.deleteComment({commentId: 'comment-123', owner: 'user-123'});
