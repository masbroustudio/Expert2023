...
describe('ThreadRepositoryPostgres', () => {
  ...
  describe('addThread function', () => {
    it('should persist added thread', async () => {
      ...
      const threadRepositoryPostgres = new ThreadRepositoryPostgres(pool, fakeIdGenerator, fakeTimestampGenerator);
  ...
  describe('verifyAvailableThread function', () => {
    it('should not throw NotFoundError when thread available', async () => {
      ...
      // Assert
      await expect(threadRepositoryPostgres.verifyAvailableThread('thread-123')).resolves.not.toThrowError('thread tidak ditemukan');
    });
    ...
    it('should throw NotFoundError when thread not available', async () => {
      ...
      // Action & Assert
      await expect(threadRepositoryPostgres.verifyAvailableThread('thread-123')).rejects.toThrowError('thread tidak ditemukan');
    });
  });
